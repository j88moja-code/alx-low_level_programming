...
/**
  * print_class - prints out the class of an ELF header.
  *
...
/**
  *print_abi - prints out the ABI version of the ELF header.
  *
...
/**
  ...
  *
  * @e_ident: pointer to an array containing the LF class.
  * @e_type: the ELF type.
  *
  * Return: nothing.
  */
...
/**
  * print_entry - prints out the entry point of an ELF header file
  *
